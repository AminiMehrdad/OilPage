...
export function TransitionLink({
  ...
  return (
    <>
      ...
      {isNavigating ? (
        <div
          className="fixed inset-0 z-[9999] flex min-h-screen items-center justify-center overflow-hidden bg-[#07100f] px-6 text-white"
          role="status"
          aria-live="polite"
        >
          ...
          <div className="relative z-10 flex w-full max-w-sm flex-col items-center text-center">
            ...
            <p className="mt-7 text-xl font-semibold">PetroVision Energy</p>
